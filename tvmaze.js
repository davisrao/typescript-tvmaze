...
var DEFAULT_SHOW_IMG = "https://tinyurl.com/tv-missing";
...
function getShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        var apiUrl, result, showData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiUrl = "https://api.tvmaze.com/search/shows?q=" + term;
                    return [4 /*yield*/, axios_1.default.get(apiUrl)];
                case 1:
                    result = _a.sent();
                    showData = result.data.map(function (res) {
                        var show = res.show;
                        return {
                            id: show.id,
                            name: show.name,
...
function getEpisodesOfShow(id) {
    return __awaiter(this, void 0, void 0, function () {
        var apiUrl, res, data, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiUrl = "https://api.tvmaze.com/shows/" + id + "/episodes";
                    return [4 /*yield*/, axios_1.default.get(apiUrl)];
                case 1:
                    res = _a.sent();
